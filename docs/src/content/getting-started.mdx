...
- **[Transactions](/guides/transactions)** - Accept one-time payments  
- **[Subscription Plans](/guides/plans)** - Create and manage recurring billing plans
- **[Subscriptions](/guides/subscriptions)** - Manage customer subscriptions and recurring billing
- **[Direct Charges](/guides/charges)** - Advanced payment flows with authentication
- **[Configuration](/configuration)** - Customize SDK behavior
- **[API Reference](/api-reference/core)** - Complete method documentation
