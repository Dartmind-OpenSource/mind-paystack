...
mixin _$Currency {
  ...
  int get subunitFactor => throw _privateConstructorUsedError;
...
abstract class $CurrencyCopyWith<$Res> {
  ...
  @useResult
  $Res call({String code, String symbol, int subunitFactor, String name});
}
    ...
    return _then(_value.copyWith(
      ...
      symbol: null == symbol
          ...
          : symbol // ignore: cast_nullable_to_non_nullable
              as String,
      subunitFactor: null == subunitFactor
          ? _value.subunitFactor
          : subunitFactor // ignore: cast_nullable_to_non_nullable
              as int,
      name: null == name
          ? _value.name
...
class _$CurrencyImpl implements _Currency {
  ...
  final String symbol;
  @override
  final int subunitFactor;
  @override
  final String name;

  @override
  String toString() {
    return 'Currency(code: $code, symbol: $symbol, subunitFactor: $subunitFactor, name: $name)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.subunitFactor, subunitFactor) ||
                other.subunitFactor == subunitFactor) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, code, symbol, subunitFactor, name);
...
abstract class _Currency implements Currency {
  const factory _Currency(
      ...
      required final int subunitFactor,
