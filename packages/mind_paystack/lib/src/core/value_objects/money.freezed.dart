...
/// @nodoc
mixin _$Money {
  int get amountInSubunits => throw _privateConstructorUsedError;
...
abstract class $MoneyCopyWith<$Res> {
  ...
  @useResult
  $Res call({int amountInSubunits, Currency currency});
...
class _$MoneyCopyWithImpl<$Res, $Val extends Money>
  ...
  @override
  $Res call({
    Object? amountInSubunits = null,
    Object? currency = null,
  }) {
    return _then(_value.copyWith(
      amountInSubunits: null == amountInSubunits
          ? _value.amountInSubunits
          : amountInSubunits // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$MoneyImpl extends _Money {
  const _$MoneyImpl({required this.amountInSubunits, required this.currency})
      : super._();
  ...
  @override
  final int amountInSubunits;
  @override
  final Currency currency;

  @override
  String toString() {
    return 'Money(amountInSubunits: $amountInSubunits, currency: $currency)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.amountInSubunits, amountInSubunits) ||
                other.amountInSubunits == amountInSubunits) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, amountInSubunits, currency);
...
abstract class _Money extends Money {
  const factory _Money(
      {required final int amountInSubunits,
      required final Currency currency}) = _$MoneyImpl;
  const _Money._() : super._();

  factory _Money.fromJson(Map<String, dynamic> json) = _$MoneyImpl.fromJson;

  @override
  int get amountInSubunits;
  @override
